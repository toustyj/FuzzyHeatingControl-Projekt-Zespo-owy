...
public class InputAndOutputSets {
    ...
    public ScrollPane infrastructurePane() {
        ...
        LineChart<Number, Number> InputTermsInsideTemp = createLineChart(data, "Optymalna temp. - wewnętrzna temp. [°C]");
        LineChart<Number, Number> InputTermsOutsideTemp = createLineChart(data, "Optymalna temp. - zewnętrzna temp. [°C]");
        LineChart<Number, Number> OutputTermsPower = createLineChart(data, "Intensywność mocy pieca");
    ...
    private LineChart<Number, Number> createLineChart(Double[] axisValues, String xAxisName) {
